    ...
    create table "iceberg"."tpch_mart_mart"."mart_revenue_summary_y1996__dbt_tmp"
      
      
    as (
      with orders as (
    -- One-year slice for 1996 to keep each batch lightweight
    select *
    from "iceberg"."tpch_mart_staging"."stg_orders"
    where order_date >= date '1996-01-01'
